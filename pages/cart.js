          ...
          <div className="flex gap-8 relative flex-col tablet:flex-row">
            <div className="tablet:w-3/6 laptop:w-4/6 w-full">
              {cart.length != 0 ? (
                ...
                <div>
                  ...
                  <Link
                    className=" mt-8 py-3 link border-2 border-[--black] rounded-[--radius] hover:border-[--accent] hover:text-[--accent] transition duration-300 w-1/2 inline-block text-center"
                    href="/products"
                  >
                    Shop
                  </Link>
            ...
            {cart.length != 0 ? (
              <div className="tablet:w-3/6 laptop:w-2/6 w-full mt-8 sticky top-[109px] right-0 h-[350px]">
                ...
                <Link
                  className="mt-8 py-3 link border-2 border-[--black] rounded-[--radius] hover:border-[--accent] hover:text-[--accent] transition duration-300 w-full inline-block text-center"
                  href={checkoutUrl}
                >
                  checkout
                </Link>
